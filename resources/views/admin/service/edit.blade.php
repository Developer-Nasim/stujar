...
<div class="col-md-12">
    <div class="main-card mb-3 card">
        @include('admin/card_head',[
            'title'=>'Edit product',
            'info'=>'Edit your products from this page, image size should be 900x600px',
            'links'=>[
                0=>['text'=>'product Management','link'=>'/admin/product'],
                1=>['text'=>'Create New product','link'=>'/admin/product/create'],
                ]  
            ])
    <div class="card-body">
    <form class="" action="{{URL::to('admin/product/'.$content->id)}}"  method="post" enctype="multipart/form-data">    
    @csrf
    @method('PATCH')
    ...
    @if(!empty($content['upload'][0]))
        ...
        <div style="display:none" id="image_upload_single">@include('admin.form_image_upload_single',['image_size' =>'Image Size 600px X 350px'])</div>
    @else
