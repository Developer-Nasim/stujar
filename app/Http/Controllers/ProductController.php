...
class ProductController extends Controller
{
    ...
    public function comments()
    {
        ...
        // dd($contents);
        return view('admin.product.index',compact('contents'));
    }
    ...
    public function create()    
    {
        ...
        // dd($tags_category );
        return view('admin.product.create',compact('tags','tags_category'));
    }
    ...
    public function show(string $id)
    {
        ...
        // dd($content);
        return view('admin.product.show',compact('content','tags','tags_category'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $content = Content::with('upload','Tag')->find($id);
        // dd($content);
        return view('admin.product.edit',compact('content','tags','tags_category'));
    }
