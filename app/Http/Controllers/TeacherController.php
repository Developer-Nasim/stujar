...
class TeacherController extends Controller
{
    ...
    {
        $teachers = Teacher::where('status' , 1 )->orderBy('id','desc')->paginate(12);
        // dd($contents);
        // return view('user_dashboard',compact('teachers'));
        return redirect('user/school')->with('teachers',$teachers); 
    }
    ...
    public function store(Request $request)
    {
        ...
        $content->stuff_type =  $request->stuff_type;
        ...
        if(!empty($request->file)){
            ...
            $isImageName = Teacher::where('file', 'LIKE', "%{$image_full_name}%")->get()->count();
            // dd($isImageName);
            if($isImageName > 0){
    ...
    public function edit(string $id)
    {
        ...
        return view('teacher.edit',compact('teacher','websettings'));
    }
